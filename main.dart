...
(context, index) {
 if (index == 0) { return ListTile( title: Text("Total
expenses: "
...
ScopedModelDescendant<ExpenseListModel>(builder: (context, child, expenses) {
...
class _FormPageState extends State<FormPage> {
 ...
 if (form.validate()) {
 form.save(); if (this.id == 0) expenses.add(Expense(0, _amount,
_date, _category));
...
9]|3[01])$'; RegExp regex = new RegExp(pattern);
 if (!regex.hasMatch(val)) return
'Enter a valid date';
 else return null;
 },
